...
<template>
    <article class="mx-auto max-w-3xl px-6 py-12 leading-relaxed animate-fade-in">
        <header class="mb-16 text-center">
            <h1
                class="fraunces text-4xl font-bold tracking-tight sm:text-5xl depth-text"
            ...
            <div class="mt-6 flex items-center justify-center gap-3">
                <router-link
                    to="/visualize"
                    class="inline-flex items-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm font-medium text-primary-foreground transition-all duration-200 hover:opacity-90 btn-press"
                >
        ...
        <PaperSection id="convergence" number="2" title="Convergence of Fourier Series">
            ...
            <Theorem type="theorem" name="Dirichlet's Theorem">
                ...
                continuity, and to
                <MathInline tex="\frac{1}{2}[f(x^+) + f(x^-)]" /> at points of
                discontinuity.
            </Theorem>
            ...
            <div
                class="my-8 rounded-xl border border-border bg-card paper-texture-aged p-6 text-center text-sm text-muted-foreground card-hover"
            >
                <p class="font-medium text-foreground mb-2">Interactive: Partial sums with adjustable N</p>
                <router-link
                    to="/visualize"
        ...
        <!-- Chapter 4: Eigenbasis Decomposition -->
